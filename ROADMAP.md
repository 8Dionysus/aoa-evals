...
- field-test the newly materialized memo recall and contradiction pilot surfaces without inflating them into general memory quality, permission policy, or canon-promotion claims
...
- field-test the materialized memo recall and contradiction pilots against wider `aoa-memo` guardrail surfaces before naming promotion, permissions, or merge bundles
