...
This draft bridge bundle uses `peer-compare`,
so its comparison posture must stay explicit and bounded.

Minimum v1 peer-comparison conditions:
- the artifact side and process side read the same bounded case family
- the matched surface stays the same bounded change case family under side-by-side artifact and workflow review
- matched conditions stay explicit enough that the reading is genuinely side-by-side
- both side readings are reviewable enough for a bounded outside reader
