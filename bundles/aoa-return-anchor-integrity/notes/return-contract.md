...
- one explicit return reason
- one or more valid anchor refs
- the active task or phase boundary being recovered
- the selected surfaces used for context rebuild
...
- the anchor is decorative rather than operative
- the rebuild secretly depends on full hidden history
