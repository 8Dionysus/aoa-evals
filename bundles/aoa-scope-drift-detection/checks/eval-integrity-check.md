...
Checked:
- the bundle stays on requested-scope vs executed-scope alignment
...
- reading scope drift detection as a substitute for overall workflow or authority evaluation
