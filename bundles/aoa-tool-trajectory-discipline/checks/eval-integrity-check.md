...
Checked:
- the bundle stays limited to cases where tool path materially matters
...
- reading tool-trajectory discipline as a default process score for all bounded tasks
