...
Checked:
- the bundle still requires separate outcome and path readings before any combined verdict
...
- reading outcome-vs-path separation as a replacement for artifact/process divergence or narrower diagnostics
