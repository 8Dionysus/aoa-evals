# Charter Amendment Evals

Status: seed v0.8.0  
Repo landing: `aoa-evals`  
Layer: Experience Polis Governance

## Purpose

Eval surfaces for charter amendments and breaking contract changes.
...
- aoa-evals receives only bounded governance surfaces.
