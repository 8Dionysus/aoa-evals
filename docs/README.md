...
- I need the system form of the proof layer:
  - [Design](../DESIGN.md)
- I need the agent-facing guidance form:
  - [Agent Surface Design](../DESIGN.AGENTS.md)
- I need the proof topology before moving artifacts or creating mechanics:
  - [Proof Topology](PROOF_TOPOLOGY.md)
- I need legacy or accepted-input naming posture:
  - [Legacy Naming](LEGACY_NAMING.md)
- I need maintained agent lane routing:
  - [Agent District](../.agents/AGENTS.md)
  - [Spark Lane](../.agents/spark/AGENTS.md)
- I need the active proof-operation atlas:
...
- I need the current proof-layer direction and next growth lanes:
  - [Roadmap](../ROADMAP.md)
- I need open proof obligations or quest source routes:
  - [Questbook](../QUESTBOOK.md)
  - [Quests](../quests/README.md)
  - [Quest Lifecycle](../quests/LIFECYCLE.md)
...
- `generated/eval_report_index.min.json`
  - use when a reader needs to find real bundle-local `*.report.json`
    artifacts; it is a derived reader, not receipt or verdict authority
...
### Topology and authority maps

These surfaces explain where proof authority sits before a change moves files,
adds mechanics, or strengthens a runtime, receipt, sibling, quest, or legacy
surface.
...
- Prefer [Spark Lane](../.agents/spark/AGENTS.md) when the question is "how should a fast-loop agent handle one bounded proof-surface change without broadening the claim?"
- Prefer [Proof Object Mechanic](../mechanics/proof-object/README.md) when the question is "how should bundle source, manifest metadata, status posture, generated readers, and bundle-local review stay aligned?"
- Prefer [Proof Loop Mechanic](../mechanics/proof-loop/README.md) when the question is "how should one proof question move from selection to reviewed report or receipt without confusing source proof, candidate evidence, generated readers, and owner handoffs?"
