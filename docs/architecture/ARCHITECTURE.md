...
| validation | nearest on-demand `VALIDATION.md` and the focused architecture proof-model route in `docs/decisions/AOA-EV-D-0093-architecture-proof-model-contract.md` |
