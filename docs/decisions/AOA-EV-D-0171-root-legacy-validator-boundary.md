...
- `python -m py_compile scripts/validators/root_legacy_common.py scripts/validators/root_legacy_naming.py scripts/validators/root_legacy_bridge_residue.py scripts/validators/root_legacy_external_leakage.py scripts/validators/root_topology.py`
