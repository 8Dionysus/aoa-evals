...
- `python -m py_compile scripts/validators/generated_eval_readmodel_common.py scripts/validators/generated_eval_catalogs.py scripts/validators/generated_eval_capsules.py scripts/validators/generated_eval_sections.py scripts/validators/generated_eval_comparison_spine.py scripts/validators/evidence_readouts.py tests/test_generated_parity.py`
- `python -m pytest -q tests/test_generated_parity.py tests/test_build_catalog.py tests/test_validate_repo.py`
