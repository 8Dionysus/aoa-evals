...
- `python -m py_compile scripts/validators/recurrence_route_paths.py scripts/validators/recurrence_route_tokens.py scripts/validators/recurrence_routes.py scripts/validators/mechanics_routes.py tests/test_mechanic_surface_contracts.py`
