# Boundary Route Checklist

This checklist routes boundary pressure for `aoa-evals` source proof surfaces.

## Operating Card

| Field | Route |
| --- | --- |
| role | boundary route checklist for new proof surfaces, duplicate shapes, scores, and readiness claims |
...
- bundles with a clearly bounded claim;
- split-axis outputs and explicit blind spots;
- schemas and examples that consumers genuinely need;
- temporary transition schemas with migration notes;
- a new proof family with distinct evidence, blind spots, and owner route.
...
1. Name the bounded claim or route pressure it answers.
2. Check whether an existing bundle, manifest variant, or mechanic part already
   owns that pressure.
3. Point the surface to its source proof meaning, owner route, and validation.

## Exit Condition

Evals clarify bounded claims and route stronger pressure to the owner that can
carry it.
