...
| --- | --- | --- | --- |
| `source-fast` | blocking growth gate | route cards, semantic AGENTS shape, source eval bundle topology, docs/decision topology, root proof boundaries | full generated freshness, release packaging, latest sibling drift |
