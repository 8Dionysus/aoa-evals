...
- it is about task-meaning ambiguity on bounded change tasks
- it is not an authority-boundary or scope-drift replacement
...
- the ambiguity class itself as a visible review object
- the handling move that was actually taken
- the boundary of any fallback assumption
