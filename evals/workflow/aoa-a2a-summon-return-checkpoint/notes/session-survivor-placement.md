...
- `repo:aoa-evals/evals/workflow/aoa-a2a-summon-return-checkpoint/EVAL.md`
- `repo:aoa-evals/evals/workflow/aoa-a2a-summon-return-checkpoint/fixtures/contract.json`
