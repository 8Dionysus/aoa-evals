...
`evals/workflow/aoa-memo-contradiction-integrity/fixtures/contract.json`,
`evals/workflow/aoa-memo-contradiction-integrity/runners/contract.json`, and the
schema-backed companion report in
`evals/workflow/aoa-memo-contradiction-integrity/reports/example-report.json`.
