...
`evals/workflow/aoa-memo-reviewed-candidate-adoption-integrity/fixtures/contract.json`,
`evals/workflow/aoa-memo-reviewed-candidate-adoption-integrity/runners/contract.json`,
