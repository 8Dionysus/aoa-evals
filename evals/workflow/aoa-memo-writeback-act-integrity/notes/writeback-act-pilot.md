...
`evals/workflow/aoa-memo-writeback-act-integrity/fixtures/contract.json`,
`evals/workflow/aoa-memo-writeback-act-integrity/runners/contract.json`, and the
schema-backed companion report in
`evals/workflow/aoa-memo-writeback-act-integrity/reports/example-report.json`.
