...
| `tests/test_roadmap_parity.py` | root-owned roadmap parity test | mechanic-owned payload status routes through mechanics/roadmap surfaces and current-contour cards | roadmap parity validation |
