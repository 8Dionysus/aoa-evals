...
- `PARTS.md`: active Agon proof-alignment part map.
- `parts/`: part-local configs, docs, examples, schemas, registries, scripts,
...
- Keep the parent name `agon`; proof, prebinding, and candidate-only posture
  belong inside parts and validators.
- Keep each Agon part bounded to one alignment pressure: court prebinding,
