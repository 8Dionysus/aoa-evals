...
This directory preserves Agon wave and former root-path provenance behind the
active `mechanics/agon/` route.

Start from `../PROVENANCE.md`, then use:

- [INDEX.md](INDEX.md) for old source to active route mapping;
