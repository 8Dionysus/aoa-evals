...
Legacy preserves old placement and path vocabulary behind the active
`mechanics/antifragility/` route.

Start from `../README.md` and `../PARTS.md`. Open this directory for former
root paths, schema locations, or shared fixture family paths that need mapping
