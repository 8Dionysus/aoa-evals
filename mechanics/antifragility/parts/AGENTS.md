...
This card applies to `mechanics/antifragility/parts/` and every descendant active part.

## Role

`mechanics/antifragility/parts/` holds active part contracts for the Antifragility proof mechanic.
...
### `mechanics/antifragility/parts/posture-review/VALIDATION.md`
...
### `mechanics/antifragility/parts/repair-proof/VALIDATION.md`
