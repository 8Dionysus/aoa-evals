...
This directory preserves lineage behind the active `audit` mechanic.
...
New audit work starts in the active part that owns the packet, hook, generated
reader, or integrity-review route.
