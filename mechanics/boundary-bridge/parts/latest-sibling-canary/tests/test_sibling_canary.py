...
if str(SIBLING_CANARY_SCRIPT_DIR) not in sys.path:
    sys.path.insert(0, str(SIBLING_CANARY_SCRIPT_DIR))
...
CANARY_MATRIX_RELATIVE = Path(CANARY_MATRIX_NAME)
