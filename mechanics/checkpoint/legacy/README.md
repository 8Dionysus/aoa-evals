...
This directory preserves checkpoint lineage behind the active
`mechanics/checkpoint/` route.

New checkpoint proof work starts in the active checkpoint parent or owning part.
