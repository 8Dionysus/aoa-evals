...
| `peer-compare` | Maintains artifact/process side-by-side peer comparison and validation-routing method readout discipline. | `mechanics/comparison-spine/parts/peer-compare/fixtures/bounded-change-paired-v1/README.md`, `mechanics/comparison-spine/parts/peer-compare/fixtures/bounded-change-paired-v2/README.md`, `mechanics/comparison-spine/parts/peer-compare/fixtures/validation-routing-bounded-v1/README.md`, `mechanics/comparison-spine/parts/peer-compare/reports/artifact-process-paired-proof-flow-v1.md`, `mechanics/comparison-spine/parts/peer-compare/reports/artifact-process-paired-proof-flow-v2.md`, `mechanics/comparison-spine/parts/peer-compare/reports/validation-routing-comparison-proof-flow-v1.md` |
