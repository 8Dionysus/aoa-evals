# Comparison Spine Legacy

Legacy comparison-spine files preserve old root fixture placement history.
Current comparison proof starts from `mechanics/comparison-spine/README.md`;
old path lineage enters through `mechanics/comparison-spine/PROVENANCE.md`.
