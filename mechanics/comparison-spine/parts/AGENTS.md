...
This card applies to `mechanics/comparison-spine/parts/` and every descendant active part.

## Role

`mechanics/comparison-spine/parts/` holds active part contracts for the Comparison Spine proof mechanic.
...
### `mechanics/comparison-spine/parts/fixed-baseline/VALIDATION.md`
...
### `mechanics/comparison-spine/parts/longitudinal-window/VALIDATION.md`
...
### `mechanics/comparison-spine/parts/peer-compare/VALIDATION.md`
