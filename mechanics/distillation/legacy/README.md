...
This district preserves placement lineage for Distillation support surfaces
after active routes exist.

Use the active route first:

1. `mechanics/distillation/README.md`
2. `mechanics/distillation/PARTS.md`
...
- `INDEX.md`: old placement to current active route lookup.
