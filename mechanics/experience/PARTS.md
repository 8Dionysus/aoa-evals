...
`experience pressure -> bounded experience proof question -> selected support surface -> bundle-local review -> bounded report or owner handoff`
...
Inputs are experience verdict packets, certification gate bundles, adoption
requests, consent records, shadow proof, compatibility refs, governance verdict
packets, runtime-boundary refs, office contours, release train packets,
rollback drills, watchtower alarms, and owner-source refs.

Outputs are bounded Experience proof readings, part-local schema/example
contracts, fixture family contracts, test-backed verdict packet shapes, route
notes, and owner handoffs.

Owner split stays explicit: `Agents-of-Abyss` owns Experience center law;
runtime, agents, memo, routing, playbooks, SDK, stats, skills, techniques,
Tree-of-Sophia, and owner repositories keep their local truth; `aoa-evals`
...
Continuity-context, service-mesh, capture-kernel, compatibility-bridge, and
runtime-boundary pressure stay folded into current parts or bundle-local proof
until local support artifacts have their own source surfaces, inputs, outputs,
owner split, stop-lines, and validation beyond one verdict packet family.
