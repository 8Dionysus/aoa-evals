...
Legacy preserves old Experience root placement as provenance behind the active
mechanic.

Use this directory to answer where an old root doc, schema, example, fixture,
or test went. New work belongs in the active part route.
