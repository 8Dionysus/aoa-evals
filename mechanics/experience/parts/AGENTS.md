...
This card applies to `mechanics/experience/parts/` and every descendant active part.

## Role

`mechanics/experience/parts/` holds active part contracts for the Experience proof mechanic.
...
### `mechanics/experience/parts/certification-gate/VALIDATION.md`
...
### `mechanics/experience/parts/governance-runtime-boundary/VALIDATION.md`
...
### `mechanics/experience/parts/office-release-train/VALIDATION.md`
...
### `mechanics/experience/parts/protocol-integrity/VALIDATION.md`
