...
This card applies to `mechanics/proof-infra/parts/` and every descendant active part.

## Role

`mechanics/proof-infra/parts/` holds active part contracts for the Proof Infra proof mechanic.
...
### `mechanics/proof-infra/parts/fixture-families/VALIDATION.md`
