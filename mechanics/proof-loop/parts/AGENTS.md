...
This card applies to `mechanics/proof-loop/parts/` and every descendant active part.

## Role

`mechanics/proof-loop/parts/` holds active part contracts for the Proof Loop proof mechanic.
