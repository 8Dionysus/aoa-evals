...
This card applies to `mechanics/proof-object/parts/` and every descendant active part.
...
- Keep source proof meaning in eval packages or source docs; validation text carries check route and evidence coverage.
