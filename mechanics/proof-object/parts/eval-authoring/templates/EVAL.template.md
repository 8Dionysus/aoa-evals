...
# comparison_surface:
#   shared_family_path: mechanics/<mechanic>/parts/<part>/fixtures/<family>/README.md
#   paired_readout_path: mechanics/<mechanic>/parts/<part>/reports/<paired-proof-flow>.md
