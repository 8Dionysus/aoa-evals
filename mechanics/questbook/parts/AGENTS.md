...
This card applies to `mechanics/questbook/parts/` and every descendant active part.

## Role

`mechanics/questbook/parts/` holds active part contracts for the Questbook proof mechanic.
...
### `mechanics/questbook/parts/dispatch-reader/VALIDATION.md`
...
### `mechanics/questbook/parts/source-record-contract/VALIDATION.md`
