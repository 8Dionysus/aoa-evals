...
- `PARTS.md`: active recurrence part map.
...
Add recurrence parts only when a repeated recurrence proof operation has a
support payload and validation. Continuity-anchor and self-reanchor stay
bundle-local until a separate evidence pass proves active support parts.
