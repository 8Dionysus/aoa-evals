...
- `fixtures/return-anchor-v1/` became
  `mechanics/recurrence/parts/anchor-return/fixtures/return-anchor-v1/`.
- `fixtures/memo-recall-guardrail-v1/` and
  `tests/test_memo_recall_phase_alpha_report.py` became
  `mechanics/recurrence/parts/memory-recall/` surfaces.
- `fixtures/recursor-readiness-boundary-v1/`, the recursor scorer, runner, and
  tests became `mechanics/recurrence/parts/recursor-boundary/` surfaces.
- `fixtures/stats-regrounding-boundary-v1/` and
  `tests/test_stats_regrounding_boundary_eval.py` became
