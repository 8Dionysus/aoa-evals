# Stats Re-Grounding Boundary Fixtures v1

This shared fixture family supports
`aoa-stats-regrounding-boundary-integrity`.

The family exists to keep one consumer-path question reviewable:
...
Each case should keep these pieces separately visible:
...
A reusable pack should include:
...
The fixture family does not prove owner artifact quality, route approval,
global stats health, or broad agent capability.
