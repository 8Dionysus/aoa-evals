...
| `docs/decisions/0014-proof-release-mechanic-package.md` | `docs/decisions/0014-release-support-mechanic-package.md` | former decision path vocabulary |
| `docs/decisions/0025-proof-release-readiness-audit.md` | `docs/decisions/0025-release-support-readiness-audit.md` | former decision path vocabulary |
