...
This directory preserves lineage behind the active `release-support` mechanic.
...
New release-support work starts in the active part that owns the readiness,
closeout, or PR handoff route.
