...
This note defines the bridge-shaped unlock-proof surface for `aoa-evals`.
...
It interprets reviewed evidence and states whether a specific unlock candidate should be:
- `grant`
- `gated_grant`
- `hold`
- `revoke`
...
Start with small scopes first:
- `quest_scoped`
- `route_scoped`
- `campaign_scoped`

The wider the scope, the stronger the burden of cited proof.

## Eligible unlock kinds

Good first bridge-wave unlock kinds:
- `ability`
- `feat`
- `difficulty_ceiling`
- `risk_ceiling`
...
Unlock proof may target more than one lone agent build.
It may also justify or gate:
- a party template
- a campaign lane
...
- cite the playbook, eval, quest, and progression refs that matter
- keep dispositions small and interpretable
- prefer `gated_grant` over overclaiming
