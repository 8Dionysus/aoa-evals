...
This card applies to `mechanics/titan/parts/` and every descendant active part.

## Role

`mechanics/titan/parts/` holds active part contracts for the Titan proof mechanic.
...
### `mechanics/titan/parts/seed-boundary/VALIDATION.md`
