...
def write_catalogs(repo_root: Path) -> tuple[Path, Path, Path, Path]:
    issues, records = collect_catalog_records(repo_root)
    if issues:
    ...
    return full_path, min_path, capsule_path, sections_path
...
def main(argv: Sequence[str] | None = None, repo_root: Path | None = None) -> int:
    ...
    try:
        ...
        full_path, min_path, capsule_path, sections_path = write_catalogs(repo_root)
