...
SRC = ROOT / 'config/agon_sophian_eval_alignment.seed.json'
OUT = ROOT / 'generated/agon_sophian_eval_alignment_registry.min.json'
ENTRY_SCHEMA = ROOT / 'schemas/agon-sophian-eval-alignment.schema.json'
REGISTRY_SCHEMA = ROOT / 'schemas/agon-sophian-eval-alignment-registry.schema.json'
BUILDER = ROOT / 'scripts/build_agon_sophian_eval_alignment_registry.py'
ITEM_KEY = 'sophian_eval_alignments'
REGISTRY_ID = 'agon.sophian_eval_alignment.registry.v1'
WAVE = 'XVIII'
