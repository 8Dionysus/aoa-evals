...
def validate_antifragility_route_surfaces(
    ...
    *,
    ...
    issues: list[ValidationIssue] = []
    _require(context, repo_root, ANTIFRAGILITY_MECHANIC_README_NAME, ANTIFRAGILITY_MECHANIC_REQUIRED_TOKENS, issues)
    _require(context, repo_root, ANTIFRAGILITY_MECHANIC_AGENTS_NAME, ANTIFRAGILITY_MECHANIC_AGENTS_REQUIRED_TOKENS, issues)
    _require(context, repo_root, ANTIFRAGILITY_MECHANIC_PARTS_NAME, ANTIFRAGILITY_MECHANIC_PARTS_REQUIRED_TOKENS, issues)
    _require(context, repo_root, ANTIFRAGILITY_PARTS_README_NAME, ANTIFRAGILITY_PARTS_README_REQUIRED_TOKENS, issues)

    parts_text = read_text_or_issue(repo_root / ANTIFRAGILITY_PARTS_README_NAME, issues, root=repo_root)
    ...
    _require(context, repo_root, ANTIFRAGILITY_POSTURE_PART_README_NAME, ANTIFRAGILITY_POSTURE_PART_REQUIRED_TOKENS, issues)
    _require(context, repo_root, ANTIFRAGILITY_STRESS_WINDOW_PART_README_NAME, ANTIFRAGILITY_STRESS_WINDOW_PART_REQUIRED_TOKENS, issues)
    _require(context, repo_root, ANTIFRAGILITY_STRESS_WINDOW_DOC_NAME, ANTIFRAGILITY_STRESS_WINDOW_DOC_REQUIRED_TOKENS, issues)
    _require(context, repo_root, ANTIFRAGILITY_REPAIR_PROOF_PART_README_NAME, ANTIFRAGILITY_REPAIR_PROOF_PART_REQUIRED_TOKENS, issues)
    _require(context, repo_root, ANTIFRAGILITY_MECHANIC_PROVENANCE_NAME, context.provenance_tokens, issues)
    _require(context, repo_root, ANTIFRAGILITY_MECHANIC_DECISION_NAME, ANTIFRAGILITY_MECHANIC_DECISION_REQUIRED_TOKENS, issues)
    _require(
        context,
        repo_root,
        ANTIFRAGILITY_PART_CONTRACT_GUARD_DECISION_NAME,
