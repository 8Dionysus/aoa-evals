...
def validate_growth_cycle_route_surfaces(
    ...
    *,
    ...
    issues: list[ValidationIssue] = []
    _require(context, repo_root, GROWTH_CYCLE_MECHANIC_README_NAME, GROWTH_CYCLE_MECHANIC_REQUIRED_TOKENS, issues)
    _require(context, repo_root, GROWTH_CYCLE_MECHANIC_AGENTS_NAME, GROWTH_CYCLE_MECHANIC_AGENTS_REQUIRED_TOKENS, issues)
    _require(context, repo_root, GROWTH_CYCLE_MECHANIC_PARTS_NAME, GROWTH_CYCLE_MECHANIC_PARTS_REQUIRED_TOKENS, issues)
    _require(context, repo_root, GROWTH_CYCLE_PARTS_README_NAME, GROWTH_CYCLE_PARTS_README_REQUIRED_TOKENS, issues)
    _require(context, repo_root, GROWTH_CYCLE_DIAGNOSIS_GATE_PART_README_NAME, GROWTH_CYCLE_DIAGNOSIS_GATE_PART_REQUIRED_TOKENS, issues)
    _require(context, repo_root, GROWTH_CYCLE_MECHANIC_PROVENANCE_NAME, context.provenance_tokens, issues)
    _require(context, repo_root, GROWTH_CYCLE_MECHANIC_DECISION_NAME, GROWTH_CYCLE_MECHANIC_DECISION_REQUIRED_TOKENS, issues)
    _require(
        context,
        repo_root,
        GROWTH_CYCLE_DIAGNOSIS_GATE_CONTRACT_DECISION_NAME,
