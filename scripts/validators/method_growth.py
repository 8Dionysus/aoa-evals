...
def validate_method_growth_route_surfaces(
    ...
    *,
    ...
    issues: list[ValidationIssue] = []
    _require(context, repo_root, METHOD_GROWTH_MECHANIC_README_NAME, METHOD_GROWTH_MECHANIC_REQUIRED_TOKENS, issues)
    _require(context, repo_root, METHOD_GROWTH_MECHANIC_AGENTS_NAME, METHOD_GROWTH_MECHANIC_AGENTS_REQUIRED_TOKENS, issues)
    _require(context, repo_root, METHOD_GROWTH_MECHANIC_PARTS_NAME, METHOD_GROWTH_MECHANIC_PARTS_REQUIRED_TOKENS, issues)
    _require(context, repo_root, METHOD_GROWTH_CANDIDATE_LINEAGE_PART_README_NAME, METHOD_GROWTH_CANDIDATE_LINEAGE_PART_REQUIRED_TOKENS, issues)
    _require(context, repo_root, METHOD_GROWTH_OWNER_LANDING_PART_README_NAME, METHOD_GROWTH_OWNER_LANDING_PART_REQUIRED_TOKENS, issues)
    _require(context, repo_root, METHOD_GROWTH_MECHANIC_PROVENANCE_NAME, context.provenance_tokens, issues)
    _require(context, repo_root, METHOD_GROWTH_MECHANIC_DECISION_NAME, METHOD_GROWTH_MECHANIC_DECISION_REQUIRED_TOKENS, issues)
    _require(
        context,
        repo_root,
        METHOD_GROWTH_PART_OWNER_SPLIT_DECISION_NAME,
