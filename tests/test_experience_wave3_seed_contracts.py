...
WAVE3_STEMS = (
    "adoption_authority_verdict",
    "adoption_compatibility_verdict",
    "adoption_eval_bundle_plan",
    "adoption_regression_verdict",
    "agonic_adoption_trial_verdict",
    "assistant_adoption_certification_verdict",
    "cross_repo_consistency_verdict",
    "federation_harvest_verdict",
    "federation_noise_verdict",
    "kag_promotion_verdict",
    "owner_consent_verdict",
    "pattern_lineage_integrity_verdict",
    "routing_adoption_verdict",
    "shadow_adoption_verdict",
    "shared_pattern_regression_verdict",
    "tos_boundary_verdict",
)
