...
WAVE4_CONTRACTS = (
    ('appeal_review_verdict', 'appeal_review_verdict_v1.json'),
    ('charter_amendment_verdict', 'charter_amendment_verdict_v1.json'),
    ('governance_verdict_bundle', 'governance_verdict_bundle_v1.json'),
    ('tos_dossier_governance_verdict', 'tos_dossier_governance_verdict_v1.json'),
    ('veto_legitimacy_verdict', 'veto_legitimacy_verdict_v1.json'),
    ('authority_resolution_integrity_v1', 'authority_resolution_integrity_v1.json'),
    ('runtime_integrity_verdict_v1', 'runtime_integrity_verdict_v1.json'),
    ('sealed_vote_integrity_verdict_v1', 'sealed_vote_integrity_verdict_v1.json'),
)
