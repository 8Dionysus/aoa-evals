...
from validators import eval_roadmap_parity as eval_roadmap_parity_validator
...
def test_validate_roadmap_parity_rejects_generic_heading(tmp_path: Path) -> None:
    ...
    issues = eval_roadmap_parity_validator.validate_roadmap_parity(
        tmp_path,
...
def test_validate_eval_index_allows_targeted_non_starter_bundle_selection(tmp_path: Path) -> None:
    ...
    issues = eval_starter_surfaces_validator.validate_eval_index(
        tmp_path,
        starter_names=["aoa-starter-alpha"],
